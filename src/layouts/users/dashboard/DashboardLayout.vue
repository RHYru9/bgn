...
import VerticalSidebarVue from '@/layouts/users/dashboard/vertical-sidebar/VerticalSidebar.vue';
import VerticalHeaderVue from '@/layouts/users/dashboard/vertical-header/VerticalHeader.vue';
